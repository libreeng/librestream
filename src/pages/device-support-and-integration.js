...
const deviceSupportandIntegration = () => {
  return (
    <Layout>
      <HeroDefault title="Device Support &amp; Integration"></HeroDefault>
      <section>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-8">
              ...
              <a href="" className="btn btn-primary btn-lg">More about hardware partners</a>
            </div>
            <div className="col-lg-4">
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-8">
              ...
              <a href="" className="btn btn-primary btn-lg">More about Ecosystem partners</a>
            </div>
            <div className="col-lg-4">
              <img src="https://via.placeholder.com/768" className="img-fluid" alt=""/>
            </div>
