        ...
        <div className="container">
          <div className="row justify-content-lg-center">
            <div className="col-lg-8">
              <div className="border-bracket text-center mb-5">
              ...
              <h3 className="text-center mt-5 mb-3">Here is your FREE copy of our Remote Expert Industry Guide.</h3>
              <div className="bg-image aspect-5x7 mb-5">
              ...
              <div className="col-12">
                <h3 className="text-center mt-5 mb-4">What will you get in this package</h3>
